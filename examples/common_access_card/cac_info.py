...
def process_card(connection, options, PIN=None):
    """
    ...
    # PIN = [0x31, 0x32, 0x32, 0x33, 0x31, 0x32]
...
if __name__ == "__main__":
    ...
    x = input("Enter in pin:")
    pin = [ord(elem) for elem in x]

    # parse user arguments
    parser.command_line(opts, process_card, pin)
